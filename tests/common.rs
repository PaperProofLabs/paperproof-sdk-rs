...
pub fn sample_preprint() -> PreprintInput {
    PreprintInput {
        ...
        series_description: Some("A local SDK test record.".to_string()),
        version_change_note: Some("Initial local SDK preprint version.".to_string()),
...
pub fn sample_software_release() -> SoftwareReleaseInput {
    SoftwareReleaseInput {
        ...
        content: sample_content(),
        series_description: Some("Rust SDK software release test artifact.".to_string()),
        version_change_note: Some("Initial release fixture.".to_string()),
        series_metadata: sample_metadata(),
        version_metadata: sample_metadata(),
        payment_coin_id: None,
    }
...
pub fn sample_blog_post() -> BlogPostInput {
    BlogPostInput {
        ...
        content: sample_content(),
        series_description: Some("Rust SDK blog test artifact.".to_string()),
        version_change_note: Some("Initial blog fixture.".to_string()),
        series_metadata: sample_metadata(),
        version_metadata: sample_metadata(),
        payment_coin_id: None,
    }
...
pub fn sample_technical_report() -> TechnicalReportInput {
    TechnicalReportInput {
        ...
        license: "CC-BY-4.0".to_string(),
        content: sample_content(),
        series_description: Some("Rust SDK technical report test artifact.".to_string()),
        version_change_note: Some("Initial report fixture.".to_string()),
        series_metadata: sample_metadata(),
        version_metadata: sample_metadata(),
        payment_coin_id: None,
    }
...
pub fn sample_dataset() -> DatasetInput {
    DatasetInput {
        ...
        keywords: vec!["sdk".to_string()],
        content: sample_content(),
        series_description: Some("Rust SDK dataset test artifact.".to_string()),
        version_change_note: Some("Initial dataset fixture.".to_string()),
        series_metadata: sample_metadata(),
        version_metadata: sample_metadata(),
        payment_coin_id: None,
    }
...
pub fn sample_generic_file() -> GenericFileInput {
    GenericFileInput {
        ...
        license: "Apache-2.0".to_string(),
        content: sample_content(),
        series_description: Some("Rust SDK generic file test artifact.".to_string()),
        version_change_note: Some("Initial generic file fixture.".to_string()),
        series_metadata: sample_metadata(),
        version_metadata: sample_metadata(),
        payment_coin_id: None,
    }
