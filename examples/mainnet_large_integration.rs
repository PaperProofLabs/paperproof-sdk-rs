...
impl Runner {
    fn publish_preprint(
        ...
        let plan = self.client.publishing.finalize_reserved_preprint(&reservation.reservation_id, &PreprintInput {
            ...
            series_description: Some("Rust SDK mainnet integration preprint artifact".to_string()),
            version_change_note: Some("Initial integration publish".to_string()),
    ...
    fn publish_generic_file(
        ...
        let plan = self
            ...
            .publish_generic_file(&GenericFileInput {
                ...
                series_description: Some("Rust SDK mainnet integration generic artifact".to_string()),
                version_change_note: Some("Initial integration publish".to_string()),
        ...
        let plan = self
            ...
            .add_preprint_version(&AddVersionInput {
                ...
                body: PreprintInput {
                    ...
                    version_change_note: Some(format!("Integration add-version round {round}")),
