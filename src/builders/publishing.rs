...
use crate::{
    ...
    types::{
        AddVersionInput, BlogPostInput, CommonContentInput, DatasetInput, GenericFileInput,
        MetadataAttribute, PreprintInput, SoftwareReleaseInput, TechnicalReportInput,
        TransferArtifactOwnerInput, UpdateSeriesDescriptionInput, UpdateSeriesMetadataInput,
    },
    validation::{
